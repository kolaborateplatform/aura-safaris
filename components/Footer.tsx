...
export default function Footer() {
  return (
    <footer className="w-full" style={{ background: '#eeeeee', borderTop: '5px solid #f8b333' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-6">
          <p className="text-sm text-gray-600">© {new Date().getFullYear()} Aura. All rights reserved.</p>
          <div className="flex space-x-4 mt-4 md:mt-0">
            {/* Social Icons (Heroicons SVGs as placeholders) */}
